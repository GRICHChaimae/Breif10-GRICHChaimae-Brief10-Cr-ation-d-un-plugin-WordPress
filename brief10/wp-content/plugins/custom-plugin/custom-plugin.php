...
Description: Footer for websites
 
Version: 1.0
 
Author: Chaimae GRICH
 
Author URI: 
 
Text Domain: Simplefooter
...
function custom_plugin_setting_page() {
    ...
    add_menu_page('Custom Plugin', 'Footer Setting', 'manage_options', 'custom-plugin-setting-url', 'custom_page_html_form' , plugins_url('custom-plugin/img/icone.png'));
